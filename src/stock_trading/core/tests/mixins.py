...
class APITestCaseMixin:
    ...
    def assertDisabledAction(
            self,
            url,
            data={},
            message="Method not allowed, action performed should disabled."
    ):
        """
        Action is disabled.
        ...
        """
        response = self.client.patch(url, data)
        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED, message)
